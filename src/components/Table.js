...
const Table = () => {
    ...
    return (
        <div className='table-responsive p-5'>
            <table className='table border' style={{border:1}}>
                <thead>
                    <tr>
                        <th>Sno</th>
                        <th>Profile Pic</th>
                ...
                <tbody className='' style={{border:'none'}}>
                    {Arr["users"].map((a, index) => (
                        <tr key={index} className=''>
                            <td>{index + 1}</td>
                            <td><img src={a["image"]} alt="img" height={50} width={50}/></td>
                            <td>{a['firstName']}</td>
                            <td>{a['lastName']}</td>
                            <td>{a['gender']}</td>
                            <td>{a['email']}</td>
